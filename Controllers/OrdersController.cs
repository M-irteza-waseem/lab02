...
namespace HF_super_mart.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.Customer).Include(o => o.Store);
        ...
        public ActionResult Create([Bind(Include = "Order_id,Customer_id,Order_date,Required_date,Shipped_date,Store_id")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Order_id,Customer_id,Order_date,Required_date,Shipped_date,Store_id")] Order order)
        {
            if (ModelState.IsValid)
            {
